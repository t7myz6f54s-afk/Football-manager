...
ls -lh ../release/Touchline-1.6.1-arm64.apk

echo "[4/4] verifying"
BT=/usr/local/android-sdk/build-tools/34.0.0
"$BT/aapt2" dump badging ../release/Touchline-1.6.1-arm64.apk | head -6 || true
unzip -l ../release/Touchline-1.6.1-arm64.apk | grep -cE "assets/game/|assets/chaquopy|lib/arm64-v8a" || true
echo "done"
